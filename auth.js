const msalConfig = {
    auth: {
        ...
        authority: "https://heyhooley.b2clogin.com/heyhooley.onmicrosoft.com/v2.0/.well-known/openid-configuration?p=B2C_1_signupsignin",  // Just the domain, tenant, and policy
